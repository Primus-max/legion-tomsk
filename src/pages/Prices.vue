...
const categories = [
  {
    ...
    items: [
      { title: 'Сиденья', price: 'от 50 000', badge: 'Хит', desc: 'Кожа, алькантара, экокожа. Демонтаж, подготовка, установка.' },
...

  {
    ...
    desc: 'Восстановление любых деталей салона с современными технологиями ремонта.',
    items: [
      { title: 'Восстановление любых деталей салона', price: 'от 1 500 000', desc: 'Восстановление и реставрация элементов салона до состояния нового.' },
      { title: 'Современная технология ремонта', price: 'от 1 500 000', desc: 'Использование современных технологий и материалов.' },
      { title: 'Подбор материалов разных производителей', price: 'от 1 500 000', desc: 'Подбор качественных материалов от различных производителей.' },
    ],
  },
  {
    key: 'sewing',
    ...
    desc: 'Изготовление и пошив чехлов по индивидуальным лекалам.',
    items: [
      { title: 'Изготовление и пошив чехлов', price: 'от 15 000', desc: 'Индивидуальный пошив, выбор материала и цвета.' },
  ...
  },
  {
    ...
    desc: 'Установка электроподогревов, диагностика автокондиционера.',
    items: [
      { title: 'Установка электроподогревов в сидения', price: 'от 1 000', desc: 'Установка электроподогревов в сидения автомобиля.' },
      { title: 'Электроподогрев руля', price: 'от 1 000', desc: 'Установка электроподогрева руля.' },
      { title: 'Диагностика автокондиционера', price: 'от 1 000', desc: 'Диагностика и обслуживание автокондиционера.' },
    ],
  },
  {
    key: 'carpets',
    ...
    items: [
      { title: 'EVO ковры', price: 'от 4 500', desc: 'Изготовление и укладка по индивидуальным лекалам.' },
      { title: '3D ковры', price: 'от 4 500', desc: '3D-ковры с бортиками, защита от влаги и грязи.' },
      { title: 'Органайзеры', price: 'от 4 500', desc: 'Органайзеры и аксессуары для багажника и салона.' },
    ],
  },
];
</script>
